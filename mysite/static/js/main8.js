!function() {
    var t = {
        ...
        6070: function(t) {
            t.exports = function(t, n) {
                for (var e = -1, r = null == t ? 0 : t.length, u = Array(r); ++e < r; )
                    u[e] = n(t[e], e, t);
                return u
            }
        },
        ...
        3254: function(t, n, e) {
            ...
            t.exports = function(t, n, e) {
                return t = o(t),
                void 0 === (n = e ? void 0 : n) ? u(t) ? f(t) : r(t) : t.match(n) || []
            }
        }
    }
      , n = {};
    ...
    function() {
        ...
        var i = class {
            constructor(n) {
                this.config = (t=>!!(t.url && t.indexes && t.indexes.monthly && t.indexes.weekly) && t)(n),
                this.ads = [],
                this.config && (n.trackImpressions,
            ...
            handleEvent(t, n) {
                ...
                try {
                    if ("ga" === t)
                        return n.dataset.trackGa && (e = JSON.parse(n.dataset.trackGa)),
                        f(e)
                } catch (t) {}
            }
        }
