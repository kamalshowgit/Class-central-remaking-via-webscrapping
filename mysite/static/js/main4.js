...
(self.webpackChunk = self.webpackChunk || []).push([[1888, 266, 7947, 5548, 2165, 577, 1623], {
    ...
    5818: function(e, t, n) {
        ...
        t.default = e=>{
            ...
            case "scroll:DOCUMENT":
                {
                    const e = (0,
                    a.Bm)().deferred.images;
                    e.length && e.forEach((function(e) {
                        (0,
                        o.oe)(e, !0) && (e.src = e.dataset.src,
    ...
    410: function(e, t, n) {
        ...
        t.default = e=>{
            if ("click:HIDE_LANG_DIALOG" === e.name)
                (0,
                a.px)("[data-name=".concat(e.detail.target, "]")).then((e=>{
                    e.remove()
                }
                )),
                (0,
                o.Z)("LOCALIZATION/HIDE_LANG_DIALOG")
        }
    },
    9028: function(e, t, n) {
        n.r(t),
                ...
                for (var a = e.length, o = t.length, i = 0, l = 0, c = 0, r = 0, s = 0, d = []; i < a && l < o; ) {
                    if (e.charAt(i) === t.charAt(l)) {
                        ...
                        for (var u = !1, m = 0; m < d.length; ) {
                            var h = d[m];
                            if (i <= h.c1 || l <= h.c2) {
                                (u = Math.abs(l - i) >= Math.abs(h.c2 - h.c1)) ? s++ : !h.trans && (h.trans = !0,
                                s++);
                                break
                            }
    ...
    5964: function(e, t, n) {
        ...
        t.default = e=>{
            ...
            case "click:ACCORDIAN_COLLAPSE":
                {
                    ...
                    o.px)("[data-name=ACCORDIAN_".concat(e.detail.target, "]")).then((n=>{
                        ...
                        (0,
                        o.cn)("icon-chevron-right-charcoal", a)),
                        (0,
                        o.cn)(t, n),
            ...
            case "click:EXPAND_TRIGGER":
                (0,
                o.px)("[data-name=EXPAND_CONTENT_".concat(e.detail.target, "]")).then((e=>{
                    (0,
                    o.IV)("hidden", e)
                }
                )),
                (0,
                o.px)("[data-name=EXPAND_PREVIEW_".concat(e.detail.target, "]")).then((e=>{
                    (0,
                    o.cn)("hidden", e)
                }
                ));
            ...
            case "click:REMOVE_PARENT":
                (0,
                o.px)("[data-name=".concat(e.detail.target, "]")).then((e=>{
                    e.remove()
                }
                ));
                break;
            ...
            case "submit:RESEND_EMAIL_VERIFICATION":
                ...
                (0,
                l.Z)("ONBOARDING/EMAIL_VERIFICATION");
                break;
            ...
            case "click:MENU_SIDEBAR":
                {
                    ...
                    if (t.classList.contains("animate-slide-in-right"))
                        return (0,
                        o.IV)("animate-slide-in-right", t),
                        (0,
                        o.cn)("animate-slide-out-left", t),
                        (0,
                        o.IV)("icon-x-charcoal", n),
                        void (0,
                        o.cn)("icon-menu-charcoal", n);
                    t.style.top = "".concat(e, "px"),
                    (0,
                    o.cn)("animate-slide-in-right", t),
                    (0,
                    o.IV)("icon-menu-charcoal", n),
                    (0,
                    o.cn)("icon-x-charcoal", n);
                    break
                }
            }
        }
    ...
    357: function(e, t, n) {
        ...
        var a = n(9894)
          ...
          , l = e=>{
            ...
            i.IV)("active", o),
            (0,
            i.px)("[data-menu-name=".concat(t.activeSubMenu, "]")).then((e=>{
                (0,
                i.cn)("active", e)
            }
            ))) : (0,
        ...
        const c = e=>{
            (0,
            i.IV)("animate-fade-hidden", e),
            (0,
            i.cn)("animate-fade-entered", e)
        }
          , r = e=>{
            (0,
            i.IV)("animate-fade-entered", e),
            (0,
            i.cn)("animate-fade-hidden", e)
        }
        ;
        var s = e=>{
            ...
            ((0,
            i.hd)().matching.includes("mediumDown") || window.TOUCHSCREEN || n.activeDropdown.match(/lists|notifications/)) && (0,
        ...
        let d = 95;
        (0,
        i.px)("[data-context-bar-offset]").then((e=>{
            const t = e.offsetTop + e.clientHeight;
            t && t > 0 && (d = t)
        }
        )),
        (0,
        i.px)("#btnProviderCoursePage").then((e=>{
            d = e.offsetTop + 40
        }
        ));
        var u = e=>{
            ...
            case "scroll:DOCUMENT":
                (e=>{
                    let {active: t} = e;
                    (0,
                    i.px)("[data-context-bar]").then((e=>t ? ((0,
                    i.IV)("animate-fade-hidden", e),
                    void (0,
                    i.cn)("animate-fade-entered", e)) : ((0,
                    i.IV)("animate-fade-entered", e),
                    void (0,
                    i.cn)("animate-fade-hidden", e))))
                }
            ...
            case "mousemove:DOCUMENT":
                if ((0,
                i.hd)().matching.includes("largeUp") && (0,
                a.y0)().nav.activeDropdown) {
                    if ((0,
                    a.y0)().nav.activeDropdown.match(/search|lists|notifications/))
                        return;
                    if (!(0,
                    i.IY)({
            ...
            case "click:BLANKET":
                {
                    ...
                    i.hd)().matching.includes("mediumDown") || window.TOUCHSCREEN || e.detail && e.detail.name.match(/lists|notifications/)))
                        return void ((0,
                        a.y0)().nav.activeDropdown !== e.detail.name && ((0,
                        a.IW)({
                            nav: {
                                ...(0,
                                a.y0)().nav,
                    ...
                    (0,
                    o.W)("notification", "CLEAR_ALL"),
                    s((0,
                    a.y0)()),
                    "lists" === e.detail.name && ((0,
                    a.sY)("modal"),
            ...
            case "mouseenter:NAV_ITEM_EXPAND":
                (0,
                i.hd)().matching.includes("mediumUp") && ((0,
                a.IW)({
                    nav: {
                        ...(0,
                        a.y0)().nav,
    ...
    9926: function(e, t, n) {
        ...
        (0,
        a.y0)().notifications && (0,
        a.y0)().notifications.length && (c(),
        setTimeout((()=>{
            (0,
            i.W)("notification", "CLEAR_ALL")
        }
        ), 1e4));
        var d = e=>{
            switch (e.name) {
            case "click:REMOVE_PARENT":
                "NEWS_BANNER" === e.detail.target && (0,
                a.y0)().notifications.length && c();
    ...
    6753: function(e, t, n) {
        ...
        class A {
            ...
            clearAll() {
                (0,
                i.Z)(this, p).removeItem((0,
                i.Z)(this, f))
            }
        }
        function w() {
            const e = (0,
            i.Z)(this, p).getItem((0,
            i.Z)(this, f));
    ...
    9504: function(e, t, n) {
        ...
        var w = e=>{
            ...
            case "request:CREATE_USER_ERROR":
                ...
                (0,
                v.Z)("SIGNUP_FORM", e.detail.fieldErrors);
                break;
    ...
    3649: function(e, t, n) {
        ...
        t.default = e=>{
            ...
            (0,
            m.px)("[data-search-container]").then((()=>{
